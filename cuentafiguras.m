function varargout = cuentafiguras(varargin)
% FINAL MATLAB code for cuentafiguras.fig
%      cuentafiguras, by itself, creates a new cuentafiguras or raises the existing
%      singleton*.
%
%      H = cuentafiguras returns the handle to a new cuentafiguras or the handle to
%      the existing singleton*.
%
%      cuentafiguras('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in cuentafiguras.M with the given input arguments.
%
%      cuentafiguras('Property','Value',...) creates a new cuentafiguras or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before cuentafiguras_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to cuentafiguras_OpeningFcn via var argin. 
%
...
% Edit the above text to modify the response to help cuentafiguras

% Last Modified by GUIDE v2.5 04-Dec-2014 17:38:27

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @cuentafiguras_OpeningFcn, ...
                   'gui_OutputFcn',  @cuentafiguras_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before cuentafiguras is made visible.
function cuentafiguras_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to cuentafiguras (see VARARGIN)

% Choose default command line output for cuentafiguras
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes cuentafiguras wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = cuentafiguras_OutputFcn(hObject, eventdata, handles) 
...
[elemento posicion] = min(simulado2);  % guarda el elemento maximo en elemento y su posicion
switch posicion
    case 1
        circulo=circulo + 1;
    case 2
...
[elemento posicion] = min(simulado3);  % guarda el elemento maximo en elemento y su posicion
switch posicion
    case 1
        circulo=circulo + 1;
    case 2
...
[elemento posicion] = min(simulado4);  % guarda el elemento maximo en elemento y su posicion
switch posicion
    case 1
        circulo=circulo + 1;
    case 2
...
[elemento posicion] = min(simulado5);  % guarda el elemento maximo en elemento y su posicion
switch posicion
    case 1
        circulo=circulo + 1;
    case 2
...
[elemento posicion] = min(simulado6);  % guarda el elemento maximo en elemento y su posicion
switch posicion
    case 1
        circulo=circulo + 1;
    case 2
...
[elemento posicion] = min(simulado7);  % guarda el elemento maximo en elemento y su posicion
switch posicion
    case 1
        circulo=circulo + 1;
    case 2
...
[elemento posicion] = min(simulado8);  % guarda el elemento maximo en elemento y su posicion
switch posicion
    case 1
        circulo=circulo + 1;
    case 2
